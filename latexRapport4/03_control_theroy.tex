...
The system matrices are first discretized using a Zero-Order Hold (ZOH) method. This converts the physical model into a discrete-time representation that perfectly aligns with the digital sampling of the PLC.
...
$$E = \frac{1}{2} I_p \dot{\theta}_{filtered}^2 + m_p g l (\cos\theta - 1)$$
...
$$u = k_{energy} E_{error} \cdot \text{direction} + k_x x$$
