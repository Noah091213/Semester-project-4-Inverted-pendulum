...
To implement LQI, the discrete system matrices ($\textbf{A}$ and $\textbf{B}$) and the penalty matrices ($\textbf{Q}$ and $\textbf{R}$) are expanded to fit this fifth state. The augmented $\textbf{Q}$ matrix receives a new diagonal value specifically to penalize the integral error.\newline
