...
The motor force during the step looks very similar for all 3 controllers. Both the LQI and PID have a different starting force, and go back to that same force after the step. Note that this graph only shows 3.5 seconds, but look similar at the end of the step. This can be seen in the data in appendix \ref{chap:code}.
